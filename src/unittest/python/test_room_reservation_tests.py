...
class TestRoomReservation(unittest.TestCase):
    ...
    def test_RoomReservation_valid1(self):
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            tarjeta.RoomReservation(1234567891011121, "Pepe Navarro", "51132027Z", 655789987,
                                     "Single", "01/01/2008", 5)
    ...
    def test_RoomReservation_valid2(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    def test_RoomReservation_valid3(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            tarjeta.RoomReservation(1234567891011121556, "Pepe Navarro", "51132027Z", 655789987,
                                     "Single", "01/01/2008", 5)
        self.assertEqual(cm.exception.message, "Tarjeta de crédito no válida")
    ...
    def test_RoomReservation_valid4(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            tarjeta.RoomReservation(123456789101, "Pepe Navarro", "51132027Z", 655789987,
                                     "Single", "01/01/2008", 5)
        self.assertEqual(cm.exception.message, "Tarjeta de crédito no válida")
    ...
    def test_RoomReservation_valid5(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            tarjeta.RoomReservation(12345678910111217, "Pepe Navarro", "51132027Z", 655789987,
                                     "Single", "01/01/2008", 5)
        self.assertEqual(cm.exception.message, "Tarjeta de crédito no válida")
    ...
    def test_RoomReservation_valid6(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            tarjeta.RoomReservation(123456789101112, "Pepe Navarro", "51132027Z", 655789987,
                                     "Single", "01/01/2008", 5)
        self.assertEqual(cm.exception.message, "Tarjeta de crédito no válida")
    ...
    def test_RoomReservation_valid2_1(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            dni.RoomReservation(6011111111111117, "Pepe Navarro", "511320279", 655789987,
                                 "Single", "01/01/2008", 5)
    ...
    def test_RoomReservation_valid2_2(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            dni.RoomReservation(6011111111111117, "Pepe Navarro", "51132¿27Z", 655789987,
                                 "Single", "01/01/2008", 5)
        self.assertEqual(cm.exception.message, "DNI no válido")
    ...
    def test_RoomReservation_valid2_3(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            dni.RoomReservation(6011111111111117, "Pepe Navarro", "51132027¿", 655789987,
                                 "Single", "01/01/2008", 5)
        self.assertEqual(cm.exception.message, "DNI no válido")
    ...
    def test_RoomReservation_valid2_4(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            dni.RoomReservation(6011111111111117, "Pepe Navarro", "5113202721Z", 655789987,
                                 "Single", "01/01/2008", 5)
        self.assertEqual(cm.exception.message, "DNI no válido")
    ...
    def test_RoomReservation_valid2_5(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            dni.RoomReservation(6011111111111117, "Pepe Navarro", "511320Z", 655789987, "Single",
                                 "01/01/2008", 5)
        self.assertEqual(cm.exception.message, "DNI no válido")
    ...
    # DNI CON DOS LETRAS
    def test_RoomReservation_valid2_6(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            dni.RoomReservation(6011111111111117, "Pepe Navarro", "511320272ZW", 655789987,
                                 "Single", "01/01/2008", 5)
        self.assertEqual(cm.exception.message, "DNI no válido")
    ...
    def test_RoomReservation_valid3_1(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            nombre.RoomReservation(6011111111111117, "Pepe ¿avarro", "11185346D", 655789987,
                                    "Single", "01/01/2008", 5)
    ...
    # NOMBRE SIN ESPACIOS
    def test_RoomReservation_valid3_2(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            nombre.RoomReservation(6011111111111117, "PepeNavarro", "11185346D", 655789987,
                                    "Single", "01/01/2008", 5)
        self.assertEqual(cm.exception.message, "Nombre no válido")
    ...
    def test_RoomReservation_valid3_3(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            nombre.RoomReservation(6011111111111117, 1234, "11185346D", 655789987, "Single",
                                    "01/01/2008", 5)
        self.assertEqual(cm.exception.message, "Nombre no válido")
    ...
    def test_RoomReservation_valid3_4(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            nombre.RoomReservation(6011111111111117, "Juan Alberto Quintana Enrique Segundo de "
    ...
    def test_RoomReservation_valid3_5(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            nombre.RoomReservation(6011111111111117, "Juan", "11185346D", 655789987, "Single",
                                    "01/01/2008", 5)
        self.assertEqual(cm.exception.message, "Nombre no válido")
    ...
    def test_RoomReservation_valid4_1(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            telefono.RoomReservation(6011111111111117, "Pepe Navarro", "11185346D", "6557899D7",
                                      "Single", "01/01/2008", 5)
    ...
    def test_RoomReservation_valid4_2(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            telefono.RoomReservation(6011111111111117, "Pepe Navarro", "11185346D", 6557899870,
                                      "Single", "01/01/2008", 5)
        self.assertEqual(cm.exception.message, "Número de teléfono no válido")
    ...
    def test_RoomReservation_valid4_3(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            telefono.RoomReservation(6011111111111117, "Pepe Navarro", "11185346D", 65578998,
                                      "Single", "01/01/2008", 5)
        self.assertEqual(cm.exception.message, "Número de teléfono no válido")
    ...
    def test_RoomReservation_valid5_1(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            habitacion.RoomReservation(6011111111111117, "Pepe Navarro", "11185346D", 655789987,
                                        "HOLA", "01/01/2008", 5)
    ...
    def test_RoomReservation_valid5_2(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    def test_RoomReservation_valid5_3(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        reserva = habitacion.RoomReservation(6011111111111117, "Pepe Navarro", "11185346D",
    ...
    @freeze_time("2024-03-16 17:00:00")
    def test_RoomReservation_valid5_4(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    @freeze_time("2024-03-16 17:00:00")
    def test_RoomReservation_valid5_5(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    def test_RoomReservation_valid6_1(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            dias.RoomReservation(6011111111111117, "Pepe Navarro", "11185346D", 655789987, "Suit",
                                  "01/01/2008", "J")
    ...
    def test_RoomReservation_valid6_2(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    def test_RoomReservation_valid6_3(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    def test_RoomReservation_valid7_1(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
        ...
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION) as\
                cm:
            fecha.RoomReservation(6011111111111117, "Pepe Navarro", "11185346D", 655789987, "Suit",
                                   "01/0D/2025", 5)
    ...
    def test_RoomReservation_valid7_2(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    def test_RoomReservation_valid7_3(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    def test_RoomReservation_valid7_4(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    def test_RoomReservation_valid7_5(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    def test_RoomReservation_valid7_6(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    def test_RoomReservation_valid7_7(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    def test_RoomReservation_valid7_8(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    def test_RoomReservation_valid7_9(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    @freeze_time("2024-03-16 17:00:00")
    def test_RoomReservation_valid7_10(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    @freeze_time("2024-03-16 17:00:00")
    def test_RoomReservation_valid(self):
        JSON_FILES_PATH = str(Path.home()) + "/PycharmProjects/G84.2024.T04.EG2/src/JsonFiles/"
        archivo = JSON_FILES_PATH + "file_store.json"
        if os.path.isfile(archivo):
            os.remove(archivo)
    ...
    def test_RoomReservation_valid2(self):
        ...
        if os.path.isfile(archivo):
            os.remove(archivo)
        manager = HOTEL_MANAGER()
        reserva1 = manager.RoomReservation(6011111111111117, "Gabriel Rivera", "12345678A",
                                           613589749,
                                           "Double", "01/02/2100", 3)
