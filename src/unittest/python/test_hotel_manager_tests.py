...
class TestHotelManager(unittest.TestCase):
    ...
    def test_room_reservation_valid5_3(self):
        ...
        habitacion = HotelManager.HotelManager()
        self.assertEqual(habitacion.room_reservation(6011111111111117, "Pepe Navarro", "11185346D",
                                                     655789987, "Single", "01/01/2100", 5),
                         HotelReservation.HOTEL_RESERVATION("11185346D", 6011111111111117,
                                                            "Pepe Navarro", 655789987,
                                                            "Single", "01/01/2100", 5).localizer)
    ...
    def test_room_reservation_valid5_5(self):
        ...
        self.assertEqual(habitacion.room_reservation(6011111111111117, "Pepe Navarro", "11185346D",
                         ...
                         HotelReservation.HOTEL_RESERVATION("11185346D", 6011111111111117,
                                                            "Pepe Navarro", 655789987, "Suit",
                                                            "01/01/2100", 5).localizer)
    ...
    def test_room_reservation_valid8_1(self):
        ...
        manager.room_reservation(6011111111111117, "Pepe Navarro", "11185346D", 655789987, "Single",
                                 "01/01/2100", 5)
        with self.assertRaises(UC3MTravel.HotelManagementException.HOTEL_MANAGEMENT_EXCEPTION):
            manager.room_reservation(6011111111111117, "Pepe Navarro", "11185346D", 655789987,
                                     "Single", "01/01/2100", 5)
    ...
    def test_room_reservation_valid(self):
        os.remove("file_store.json")
        manager = HotelManager.HotelManager()
        reserva = manager.room_reservation(6011111111111117, "Pepe Navarro", "11185346D", 655789987,
                                           "Single", "01/01/2100", 5)
